class GossipsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @gossip.save
        format.html { redirect_to gossips_path, notice: 'Gossip was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @gossip.update(gossip_params)
        format.html { redirect_to gossips_path, notice: 'Gossip was successfully updated.' }
