...
class GossipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gossip" do
    assert_difference('Gossip.count') do
      post gossips_url, params: { gossip: { content: @gossip.content, moussaillon_id: @gossip.moussaillon_id } }
    end
  ...
  test "should update gossip" do
    patch gossip_url(@gossip), params: { gossip: { content: @gossip.content, moussaillon_id: @gossip.moussaillon_id } }
